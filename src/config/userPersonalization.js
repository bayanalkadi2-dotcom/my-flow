...
export const userPersonalizations = {
  school: {
    ...
    contextQuestionOptions: [
      ...
      ['appointments', 'Termine'],
      ['self_organization', 'Selbstorganisation'],
      ['performance_pressure', 'Druck'],
      ['little_free_time', 'zu wenig Freizeit'],
    ],
    texts: {
      dashboardTitle: 'Dein Alltag im Überblick',
      dashboardSubtitle: 'Behalte Aufgaben, Termine und Pausen im Blick.',
      routinesTitle: 'Routinen für deinen Alltag',
      checkInIntro: 'Wie geht es dir heute mit Alltag, Fokus und Erholung?',
      statisticsIntro: 'Hier siehst du deinen Fortschritt bei Routinen und Check-ins.',
      profileDescription: 'Deine Angaben helfen MyFlow, deinen Alltag passend zu begleiten.',
    },
    routineSuggestions: [
      { id: 'daily-planning-school', title: 'Tagesplanung', category: 'Organisation', target: 1, unit: 'Mal' },
      { id: 'prepare-day', title: 'Tag vorbereiten', category: 'Organisation', target: 1, unit: 'Mal' },
      { id: 'short-break', title: 'Kurze Pause', category: 'Erholung', target: 10, unit: 'Minuten' },
